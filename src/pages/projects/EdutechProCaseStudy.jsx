...
import { ArrowLeft, BookOpen, Zap, CheckCircle, Clock, Users, Video, BarChart3 } from "lucide-react";
import Navbar from "../../components/Navbar";
import Footer from "../../components/Footer";
import { edutech } from "../../assets/app";

const EdutechProCaseStudy = () => {
  const project = {
    id: "edutech-pro",
    title: "EDUTECH PRO",
    description: "Learning Management & Virtual Classroom Platform",
    category: "education",
    ...
    executiveSummary: {
      ...
      challenge: "Low student engagement and poor resource accessibility in traditional and online learning environments, leading to ineffective knowledge transfer",
      solution: "Interactive learning management system with virtual classroom capabilities",
      results: [
        "60% increase in student engagement",
        "40% more active users regularly returning",
        "4.7/5 user satisfaction score",
        "Dynamic learning environment established"
      ]
    },

    // Problem Section
    problem: {
      title: "The Challenge: Modernizing Educational Engagement",
      description: "Traditional and online learning platforms were failing to engage students effectively, with poor accessibility to resources and limited interactive features hindering knowledge transfer and student participation.",
      painPoints: [
        {
          icon: "📚",
          title: "Low Engagement",
          description: "Passive learning experiences leading to poor student participation"
        },
        {
          icon: "🔗",
          title: "Poor Accessibility",
          description: "Limited access to learning resources and course materials"
        },
        {
          icon: "🏫",
          title: "Traditional Methods",
          description: "Outdated teaching approaches failing to engage modern learners"
        },
        {
          icon: "📊",
          title: "Limited Analytics",
          description: "Insufficient insights into student progress and performance"
        }
      ],
      quote: {
        text: "Our students were disengaged with traditional online learning platforms. We needed a solution that could bring the classroom experience to life digitally while providing the tools educators need to track and improve learning outcomes.",
        author: "Director of Educational Technology"
      }
    },

    // Solution Section
    solution: {
      title: "Our Solution: Interactive Learning Ecosystem",
      overview: "We developed EDUTECH PRO as a comprehensive learning management platform using Vue.js for an interactive user interface, Python (Django) for a robust backend, and PostgreSQL for reliable data management with advanced analytics.",
      whyThisStack: [
        "Vue.js for responsive and interactive learning interfaces",
        "Python (Django) for scalable educational backend services",
        "PostgreSQL for reliable academic data management",
        "WebRTC for high-quality virtual classroom experiences"
      ],
      keyFeatures: [
        {
          title: "Virtual Classroom",
          description: "Live video sessions with interactive tools and real-time collaboration",
          icon: <Video className="w-6 h-6" />
        },
        {
          title: "Learning Management",
          description: "Structured course content and progress tracking system",
          icon: <BookOpen className="w-6 h-6" />
        },
        {
          title: "Engagement Tools",
          description: "Gamification and interactive features to motivate learners",
          icon: <Users className="w-6 h-6" />
        },
        {
          title: "Analytics Dashboard",
          description: "Comprehensive insights into student participation and performance",
    ...
    // Implementation
    implementation: {
      title: "Development & Educational Integration Process",
      timeline: "16 Weeks",
      phases: [
        {
          phase: "Educational Strategy & Architecture",
          duration: "4 Weeks",
          activities: [
            "Learning methodology and engagement strategy design",
            "Educational content management architecture",
            "Virtual classroom technical specifications",
        ...
        },
        {
          ...
          duration: "7 Weeks",
          activities: [
            "Vue.js frontend with interactive learning components",
            "Python Django backend with educational APIs",
            "PostgreSQL database with academic data models",
            "WebRTC virtual classroom implementation"
          ]
        },
        {
          phase: "Engagement Features & Testing",
          duration: "3 Weeks",
          activities: [
            "Gamification and interactive element integration",
            "Virtual classroom functionality validation",
            "Educator and student usability testing",
        ...
        },
        {
          ...
          duration: "2 Weeks",
          activities: [
            "Platform deployment and educator onboarding",
            "Instructor training and course migration",
            "Student orientation and support materials",
            "Ongoing educational support setup"
          ]
        }
      ]
    },
    ...
    // Technical Details
    technical: {
      architecture: "Modular architecture with real-time collaboration capabilities",
      frontend: "Vue.js with interactive learning components",
      backend: "Python Django with RESTful educational APIs",
      database: "PostgreSQL with academic data optimization",
      integrations: ["Video Conferencing", "Payment Systems", "Content Management", "Analytics"],
      hosting: "Scalable cloud infrastructure with global CDN"
    },

    // Results
    results: {
      title: "Educational Impact & Learning Outcomes",
      metrics: [
        {
          value: "60%",
          label: "Engagement Increase",
          description: "Higher student participation and interaction"
        },
        {
          value: "40%",
          label: "Active Users",
          description: "More users regularly returning to platform"
        },
        {
          value: "4.7/5",
          label: "User Score",
          description: "Excellent satisfaction from students and educators"
        },
        {
          value: "Real-time",
          label: "Collaboration",
          description: "Live virtual classroom interactions"
        }
      ],
      benefits: [
        {
        ...
        },
        {
          ...
          items: [
            ...
            "Easy course content management and updates",
            "Interactive teaching tools and virtual whiteboards",
        ...
        },
        {
          ...
          items: [
            "Expanded reach through virtual classrooms",
    ...
    // Technology Stack
    technologies: [
      { category: "Frontend", stack: ["Vue.js", "JavaScript", "HTML5", "CSS3"] },
      { category: "Backend", stack: ["Python", "Django", "REST API", "WebSocket"] },
      { category: "Database", stack: ["PostgreSQL", "Data Analytics", "Backup Systems"] },
      { category: "Learning Tools", stack: ["WebRTC", "Interactive Quizzes", "Virtual Whiteboard"] }
    ],

    // Project Team
    team: {
      size: "7 Developers + 2 Education Specialists",
      duration: "16 Weeks",
      methodology: "Agile with educational methodology integration"
    }
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative group">
              ...
              <img
                ...
                alt={`${project.title} Learning Platform`}
      ...
      <section className="w-full px-6 sm:px-10 lg:px-16 py-20 bg-gradient-to-br from-white via-white/50 to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            {/* Key Features */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Learning Features</h3>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-gray-50 to-white/80 rounded-2xl p-8 md:p-12 text-center border border-white/40 backdrop-blur-sm">
            ...
            <p className="text-gray-600 mb-8 text-lg max-w-2xl mx-auto leading-relaxed">
              Let's discuss how we can create engaging, interactive learning platforms to enhance student participation and modernize educational delivery.
            </p>
...
export default EdutechProCaseStudy;