...
import { ArrowLeft, ShoppingCart, Zap, CheckCircle, BarChart3, Cpu, Rocket, Shield } from "lucide-react";
import Navbar from "../../components/Navbar";
import Footer from "../../components/Footer";
import { shopex } from "../../assets/app";


const ShopnexCaseStudy = () => {
  const project = {
    id: "shopnex",
    title: "SHOPNEX",
    ...
    executiveSummary: {
      ...
      challenge: "Generic online storefront suffering from low conversion rates and slow performance, hindering sales growth and customer retention",
      solution: "AI-powered e-commerce platform with personalized shopping experiences",
      results: [
    ...
    // Problem Section
    problem: {
      title: "The Challenge: Generic E-commerce Limitations",
      description: "The existing online store was struggling with poor performance, low engagement, and generic shopping experiences that failed to convert visitors into customers effectively.",
      painPoints: [
        {
          icon: "📉",
          title: "Low Conversion",
          description: "Poor visitor-to-customer conversion rates"
        },
        {
          icon: "🐌",
          title: "Slow Performance",
          description: "Lengthy load times leading to high bounce rates"
        },
        {
          icon: "🛒",
          title: "Generic Experience",
          description: "One-size-fits-all approach without personalization"
        },
        {
          icon: "💳",
          title: "Checkout Friction",
          description: "Complex payment processes causing cart abandonment"
        }
      ],
      quote: {
        text: "We were losing potential customers to slow load times and generic shopping experiences. We needed a platform that could deliver personalized, fast, and engaging e-commerce.",
    ...
    // Solution Section
    solution: {
      title: "Our Solution: Intelligent E-commerce Platform",
      overview: "We developed SHOPNEX as a cutting-edge e-commerce solution using Next.js for lightning-fast performance, Sanity CMS for dynamic content management, Stripe for secure payments, and TensorFlow.js for AI-driven personalization.",
      whyThisStack: [
        "Next.js for server-side rendering and optimal performance",
        "Sanity CMS for flexible product and content management",
      ...
      keyFeatures: [
        ...
        },
        {
          ...
          description: "2x faster load times with optimized storefront",
        ...
        },
        {
          ...
          description: "Flexible CMS for promotions and product updates",
    ...
    // Implementation
    implementation: {
      title: "Development & Optimization Process",
      timeline: "12 Weeks",
      phases: [
        {
          phase: "Architecture & AI Planning",
          duration: "3 Weeks",
          activities: [
            "E-commerce performance optimization strategy",
            "AI recommendation algorithm design",
            "Payment and security architecture",
        ...
        },
        {
          ...
          duration: "5 Weeks",
          activities: [
            "Next.js storefront with server-side rendering",
        ...
        },
        {
          ...
          duration: "2 Weeks",
          activities: [
            "Machine learning model training with product data",
            "Performance optimization and load testing",
            "User experience testing and refinement",
            "Security and payment processing validation"
          ]
        },
        {
          phase: "Launch & Analytics",
          duration: "2 Weeks",
          activities: [
    ...
    // Technical Details
    technical: {
      architecture: "JAMstack architecture with serverless functions",
      frontend: "Next.js with TypeScript and React",
      backend: "Node.js with serverless APIs",
      database: "Sanity CMS with real-time content updates",
      integrations: ["Stripe Payments", "TensorFlow.js", "Analytics", "CDN"],
      hosting: "Vercel with global CDN distribution"
    },

    // Results
    results: {
      title: "E-commerce Performance & Business Impact",
      metrics: [
        {
          value: "30%",
          label: "Higher Conversion",
          description: "Increased visitor-to-customer conversion rate"
        },
        {
          value: "2x",
          label: "Faster Load Times",
          description: "Significantly improved site performance"
        },
        {
          value: "4.8/5",
          label: "User Score",
          description: "Excellent customer experience rating"
        },
        {
          value: "AI-Powered",
      ...
      benefits: [
        {
          ...
          items: [
            "Personalized shopping journeys for each visitor",
            "Faster page loads reducing bounce rates",
        ...
        },
        {
          ...
          items: [
            "Easy content and product management through CMS",
            "Automated inventory and promotion updates",
    ...
    // Technology Stack
    technologies: [
      { category: "Frontend", stack: ["Next.js", "TypeScript", "React", "Tailwind CSS"] },
      { category: "Backend", stack: ["Node.js", "Serverless Functions", "API Routes"] },
      { category: "AI & CMS", stack: ["TensorFlow.js", "Sanity CMS", "Machine Learning"] },
      { category: "Payments & Infrastructure", stack: ["Stripe", "Vercel", "CDN", "Analytics"] }
    ],

    // Project Team
    team: {
      size: "6 Developers + 1 AI Specialist",
      duration: "12 Weeks",
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative group">
              ...
              <img
                ...
                alt={`${project.title} E-commerce Platform`}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-gray-50 to-white/80 rounded-2xl p-8 md:p-12 text-center border border-white/40 backdrop-blur-sm">
            ...
            <p className="text-gray-600 mb-8 text-lg max-w-2xl mx-auto leading-relaxed">
              Let's discuss how we can create intelligent, high-performance e-commerce solutions to drive conversions and deliver exceptional shopping experiences.
            </p>
...
export default ShopnexCaseStudy;