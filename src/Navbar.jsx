...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`lg:hidden absolute top-full left-0 w-full bg-white backdrop-blur-lg border-t border-gray-100 shadow-2xl transition-all duration-500 ease-in-out ${
          menuOpen
